<template>
  <nav
    ...
    flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6"
  >
    <div
    ...
    >
      ...
      <div
        ...
        md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto
        ...
        >
          <div class="flex flex-wrap">
            ...
            <div class="w-6/12 flex justify-end">
              <button
                type="button"
                class="cursor-pointer text-black opacity-50 md:hidden px-3 py-1
        ...
        <form class="mt-6 mb-4 md:hidden">
          <div class="mb-3 pt-0">
            <input
              type="text"
              placeholder="Search"
              class="border-0 px-3 py-2 h-12 border border-solid border-blueGray-500
              placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-base
